...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: <TableIcon />,
    subItems: [
      { name: "Team triển khai", path: "/superadmin/implementation-tasks", pro: false },
      { name: "Team Dev", path: "/superadmin/dev-tasks", pro: false },
      { name: "Team Bảo trì", path: "/superadmin/maintenance-tasks", pro: false },
    ],
  },
];
